        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Laporan AR</span>
                </div>
                <div class="actions">
                    ...
                    <div class="row">
                        <div class="form-body">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
									<input id="id_idCust" class="form-control input-sm hidden"
                                               type="text" name="idCust" readonly/>
                                    <label>ID Customer</label>
									<div class="input-group">
                                        <input id="id_customer" required="required" class="form-control input-sm"
                                               type="text" name="customer" readonly/>    
										<span class="input-group-btn">
											<a href="#" class="btn btn-success btn-sm" data-target="#idDivTabelCust"
...
<!--  MODAL Data Karyawan -->
<div class="modal fade draggable-modal" id="idDivTabelCust" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
            ...
            <!-- END MODAL BODY-->
            <div class="modal-footer">
                <button type="button" class="btn default" data-dismiss="modal" id="btnCloseModalDataCust">Close</button>
            </div>
        </div>
        <!-- /.modal-content -->
    </div>
...
<script>
	...
	var TableManaged = function () {
        ...
        var initTable2 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/laporan_ar/getCustAll"); ?>",
                "columns": [
                    {"data": "idCust"},
                    {"data": "nama"},
                    {"data": "alamat"}
            ...
            table.on('click', 'tbody tr', function () {
                ...
                var namaCust = $(this).find("td").eq(1).html();
                
				$('#id_idCust').val(idCust);
                $('#id_customer').val(namaCust);
				
                $('#btnCloseModalDataCust').trigger('click');
	...
	function cetak(){
		...
		var customer = $('#id_idCust').val();
		if(rumah == ''){
			alert('Silahkan pilih nama rumah');
			return false;
		}
		if(customer == ''){
			alert('Silahkan pilih ID Customer');
			return false;
		}else{
			window.open("<?php echo base_url('laporan_ar/cetak/'); ?>/"+rumah+"/"+customer, '_blank');	
		}
	}
