        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Daftar Nominatif</span>
                </div>
                <div class="actions">
...
<script>
	...
	function cetak(){
		...
		if(tglAkhir == ''){
			...
			window.open("<?php echo base_url('laporan_nominatif/cetak/'); ?>/"+tglAwal+"/"+tglAkhir, '_blank');	
		}
	}
