...
<html lang="en">
  ...
  <body>
	...
	<table class="tableizer-table2">
	 ...
	 } ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Pay/Refund To</td><td width="25%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->pay_to; ?></td><td>&nbsp;</td></tr>
	 ...
	 </td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Account Name</td><td width="25%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->nama_akun_bank; ?></td><td>&nbsp;</td></tr>
	 ...
	 </td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Account No.</td><td width="25%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->no_akun_bank; ?></td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="2">Due/Refund date</td>
	 <td width="25%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">
	 <?php echo tgl_indo($a->tgl_jt); ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Bank</td><td width="25%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->nama_bank; ?></td><td>&nbsp;</td></tr>
	...
	<table class="tableizer-table2">
	 ...
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_fpe == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Invoice Asli</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_suratjalan == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="3">  Surat Jalan (Delivery Order)</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_ssp == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="6">  Sesuai Surat Perjanjian / Kontrak</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_kuitansi == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Kwitansi (Receipt) Asli</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_lappenerimaanbrg == '1'){ echo 'V';}else{ echo '';}?></td><td width="25%" colspan="3"> LPB / Pelaksanaan Jasa</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_sspk == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="6"> Sesuai Surat Perintah Kerja (SPK)</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_fpa == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Faktur Pajak Asli</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_bast == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="3"> Berita Acara Serah Terima (BAST)</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_lpjum == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="6"> Laporan Pertanggungjawaban Uang Muka</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_po == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Purchase Order (PO)</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_bap == '1'){ echo 'V';}else{ echo '';}?></td><td width="25%" colspan="3">  BAP / Proggress Report</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="6"></td><td>&nbsp;</td></tr>
	 <tr><td colspan="24">&nbsp;</td></tr>
	 ...
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->inout_budget == '0'){ echo 'V';}else{ echo '';}?></td><td colspan="3">Within Budget</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->inout_budget == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="3">Out of Budget</td><td colspan="10">&nbsp;</td></tr>
	 ...
	 <tr><td>&nbsp;</td><td colspan="6">&nbsp;</td><td>Name</td><td colspan="4" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif; width: 20%">&nbsp;</td><td colspan="4" style="width: 22%">&nbsp;</td><td style="width: 5%;">Name</td><td colspan="3" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif; width: 20%">&nbsp;</td><td colspan="4">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="6">&nbsp;</td><td rowspan="3">Signature</td><td colspan="4" rowspan="3" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="4">&nbsp;</td><td rowspan="3">Signature</td><td colspan="3" rowspan="3" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="4">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="6">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="6">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="6">&nbsp;</td><td>Date</td><td colspan="4" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="4">&nbsp;</td><td>Date</td><td colspan="3" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="4">&nbsp;</td></tr>
