    ...
    var TableManaged = function () {
        ...
        var initTable3 = function () {
            ...
            table.on('click', 'tbody tr', function () {
                ...
                var namaSpl = $(this).find("td").eq(1).html();
                var namaAkunBank = $(this).find("td").eq(2).html();
                var noAkunBank = $(this).find("td").eq(3).html();
                var namaBank = $(this).find("td").eq(4).html();

                $('#id_splId').val(idSpl);
                $('#id_payTo').val(namaSpl);
                $('#id_namaPemilikAkunBank').val(namaAkunBank);
