        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Budget vs realisasi</span>
                </div>
                <div class="actions">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
									...
									<?php
										...
										endforeach; 
										echo form_dropdown('tahun', $data,'','id="id_tahun" class="form-control select2me input-sm"');
									?>                                                   
                                </div>
                            </div>
...
<script>
	...
	function cetak(){
		...
		if(tahun == ''){
			...
			window.open("<?php echo base_url('laporan_budget_realisasi/cetak/'); ?>/"+tahun+"/"+proyek+"/"+nol, '_blank');	
		}
	}
