                            	...
                            	<div class="form-group">
                                    ...
                                    <div class="checkbox-list">
                                            <label>
                                                ...
                                                Within Budget </label>
                                            <input type="text" name="inoutBudget_in" id="id_inoutBudget_in" class="nomor1 hidden inbudget">
                                            <label>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
									...
									<div class="checkbox-list">
										...
										<label>
										<input type="checkbox"  value="1" name="dokLPKK" id="id_dokLPKK">  Laporan Penggunaan  Kas Kecil</label>
										<input type="text" name="dokLPKK_in" id="id_dokLPKK_in" class="nomor1 hidden">
									</div>
								</div>
                            </div>	
                        </div>
    ...
    <script>
        ...
        var TableManaged = function () {
            var initTable1 = function () {
                ...
                // begin first table
                table.dataTable({
                    "ajax": "<?php  echo base_url("/approval_reimpay/getAllRb"); ?>",
                    "columns": [
                        {"data": "idRb"},
                        {"data": "namaKyw"},
                        {"data": "deptKyw"},
        ...
        function ajax_submit_tambah() {
            $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>approval_reimpay/approval",
                data: dataString,
                dataType: "json",
        ...
        function getDescRb(id) {
            ...
            var idRb = id;
            if (idRb != '') {
                $.post("<?php echo site_url('/approval_reimpay/getDescReimpay'); ?>",
                    {
                        'idRb': idRb
                    }, function (data) {
                        //console.log(data);
                        if (data.baris == 1) {
                            ...
                            if(data.dok_lpkk == '1'){
                                $("#uniform-id_dokLPKK span").addClass("checked");
                                $('#id_dokSSP_in').val('1');
                            }else{
                                $("#uniform-id_dokLPKK span").removeClass("checked");
                                $('#id_dokLPKK_in').val('0');
                            }
