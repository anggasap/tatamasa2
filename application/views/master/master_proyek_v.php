        ...
        <div class="portlet light bordered">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post" class="cls_from_sec_proyek"
                      action="<?php echo base_url('master_proyek/home'); ?>" id="id_formProyek">
                    <div class="row">
                        <div class="form-body">
                            <div class="col-md-12">
