...
<script>
    ...
    var TableManaged = function () {
        ...
        var initTable2 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php  echo base_url("/master_settle_adv/getSettlementReq"); ?>",
                "columns": [
                    {"data": "idSettle"},
                    {"data": "namaReq"},
                    {"data": "jmlUangAdv"},
        ...
        var initTable3 = function () {
            ...
            // begin first table
            table.dataTable({
                "ajax": "<?php echo base_url("/master_settle_adv/getAdvReq"); ?>",
                "columns": [
                    {"data": "idAdv"},
                    {"data": "namaReq"},
                    {"data": "jmlUang"}
    ...
    $('#id_uangPaidou').focusout(function (){
        var uang = $(this).val();
        alert(uang);
        $('#id_jumlahCPA').val(number_format(uang,2));
    });
    $('#id_paid').focusout(function (){
        var uang = $('#id_uangPaidou').val();
        $('#id_jumlahCPA').val(number_format(uang,2));
    });
    ...
    $('#id_formSettle').submit(function (event) {
        ...
        if(jmlCpa == 0){
			...
			alert('Pilih salah satu dokumen terlampir');
			return false;	
		}else{
