        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Laporan SPK</span>
                </div>
                <div class="actions">
            ...
            <div class="portlet-body">
                ...
                <form role="form" method="post" id="id_laporanSpk">
                    <div class="row">
                        <div class="form-body">
                            <div class="col-md-6">
...
<script>
	...
	function cetak(){
		...
		if(tanggal == ''){
			...
			window.open("<?php echo base_url('laporan_spk/cetak/'); ?>/"+tanggal, '_blank');
		}
	}
