        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Arus Kas Perbulan</span>
                </div>
                <div class="actions">
                        ...
                        <div class="form-body">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Tanggal</label>
									<input id="id_tanggal" data-date-format="dd-mm-yyyy" placeholder="dd-mm-yyyy" class="form-control date-picker input-sm" type="text" name="tanggal" />                               
                                </div>
                            </div>
...
<script>
	...
	function cetak(){
		...
		if(tahun == ''){
			...
			alert('Silahkan pilih proyek');
			return false;
		}
		else{
			window.open("<?php echo base_url('laporan_arus_cashflow/cetak/'); ?>/"+tahun+"/"+proyek+"/"+nol, '_blank');	
		}
	}
