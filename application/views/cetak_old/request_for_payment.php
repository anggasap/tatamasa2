...
<html lang="en">
  ...
  <body>
	...
	<table class="tableizer-table2">
	 ...
	 <td colspan="4">&nbsp;</td><td>Date</td><td colspan="5" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->app_keuangan_status != '0'){ echo tgl_indo($a->app_keuangan_tgl);}else{ echo '';} ?></td><td colspan="4">&nbsp;</td></tr>
