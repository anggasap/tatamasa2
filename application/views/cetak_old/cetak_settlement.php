...
<html lang="en">
  ...
  <body>
	...
	<table class="tableizer-table2">
	 ...
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_fpe == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Faktur Penjualan (Invoice) Asli</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_suratjalan == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="3">  Surat Jalan (Delivery Order)</td><td width="10%">&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_ssp == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="6">  Sesuai Surat Perjanjian / Kontrak</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_kuitansi == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Kwitansi (Receipt) Asli</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_lappenerimaanbrg == '1'){ echo 'V';}else{ echo '';}?></td><td width="25%" colspan="3"> Laporan Penerimaan Barang / Pelaksanaan Jasa</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_sspk == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="6"> Sesuai Surat Perintah Kerja (SPK)</td></tr>
	 ...
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_po == '1'){ echo 'V';}else{ echo '';}?></td><td width="20%" colspan="6">Purchase Order (PO)</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_bap == '1'){ echo 'V';}else{ echo '';}?></td><td width="25%" colspan="3">  Berita Acara Pemeriksaan / Proggress Report</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="6"></td><td>&nbsp;</td></tr>
	 <tr><td colspan="24">&nbsp;</td></tr>
