...
<html lang="en">
  ...
  <body>
	...
	<tr class="tableizer-firstrow"><th colspan="14">Kwitansi</th>
	<?php foreach($rows1 as $i){ ?>	
	...
	?>	
		...
		<td align="right"><?php echo number_format($a->sdhdibayar,2,'.',','); ?></td>
		</tr>
	<?php 
	?>
	<tr><td colspan="2">Total</td><td align="right"><?php echo number_format($a->sdhdibayar,2,'.',','); ?></td></tr>
	<tr><td colspan="3" align="center"><?php echo '#'.Terbilang($a->sdhdibayar).' Rupiah #'; ?></td></tr>
	</table>
	<?php } ?>
	<br/>
