                            ...
                            <div class="row">
                                <div class="form-body">
                                    ...
                                    <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                            <input id="id_uangPaidou" required="required"
                                                   class="form-control input-sm nomor hidden"
...
<div class="modal fade draggable-modal" id="idDivTabelReqpay" tabindex="-1" role="basic" aria-hidden="true">
    <div class="modal-dialog  modal-lg">
        <div class="modal-content">
            ...
            <!-- END MODAL BODY-->
            <div class="modal-footer">
                <button type="button" class="btn default" data-dismiss="modal" id="btnCloseModalDataReqpay">Close
                </button>
            </div>
        </div>
        <!-- /.modal-content -->
