                        ...
                        <div class="form-body">
                            <div class="col-md-12">
								...
								<div class="form-group">
                                    ...
                                    <select id="id_idjenis" name="jenis" required="required" class="form-control">
										<option value=""></option>
										<option value="T">Tunai</option>
										<option value="NT">Non Tunai</option>
									</select>
								</div>	
                                <div class="form-group">
    ...
    var TableManaged = function () {
        ...
        var initTable1 = function () {
            ...
            table.on('click', 'tbody tr', function () {
				...
				var jenis = $(this).find("td").eq(3).html();
                var kodeGLAcc = $(this).find("td").eq(4).html();
                                
                $('#id_jnsbyrId').val(idAcc);
                $('#id_namaJnsbyr').val(namaAcc);
                $('#id_norekBank').val(norekAcc);
                $('#id_GL').val(kodeGLAcc);
				$('#id_idjenis').val(jenis);
                getDescGL(kodeGLAcc);
                //$('#').val();
