...
foreach($rows1 as $r){
	...
	$this->fpdf->Cell(4 , 0.5, 'Harga Jual' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	...
	$this->fpdf->Cell(4 , 0.5, '' , 0, 'LR', 'L');
	$this->fpdf->Cell(4 , 0.5, 'Booking Fee' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, number_format($r->booking,2,'.',','),0,0,'L');
	$this->fpdf->Ln();
	$this->fpdf->Cell(2.5 , 0.5, 'No. HP' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, $r->no_hp,0,0,'L');
	$this->fpdf->Cell(4 , 0.5, '' , 0, 'LR', 'L');
	$this->fpdf->Cell(4 , 0.5, 'Harga Setelah Booking' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, number_format($r->harga,2,'.',','),0,0,'L');
	$this->fpdf->Ln();
	...
	$this->fpdf->Cell(4 , 0.5, '' , 0, 'LR', 'L');
	$this->fpdf->Cell(4 , 0.5, 'DP' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, number_format($r->hargamj,2,'.',','),0,0,'L');
	$this->fpdf->Ln();
	$this->fpdf->Cell(2.5 , 0.5, 'ID Costumer' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, $r->no_id,0,0,'L');
	$this->fpdf->Cell(4 , 0.5, '' , 0, 'LR', 'L');
	$this->fpdf->Cell(4 , 0.5, 'Sisa/KPR' , 0, 'LR', 'L');
	$this->fpdf->Cell(0.5 , 0.5, '=' , 0, 'LR', 'L');
	$this->fpdf->Cell(5 , 0.5, number_format($r->sisa_dp,2,'.',','),0,0,'L');
	$this->fpdf->Ln();
}
$this->fpdf->Ln();
...
foreach($rows3 as $r2)
{
	...
	$this->fpdf->Cell(4 , 0.5, $no , 1, 'LR', 'C');
	$this->fpdf->Cell(6 , 0.5, tgl_indo($r2->tgl_trans), 1, 'LR', 'C');
