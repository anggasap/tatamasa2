...
<html lang="en">
  ...
  <body style="width:100%;">
	...
	<tr class="tableizer-firstrow"><th colspan="14">BANK PAYMENT - SETTLEMENT</th></tr>
	</table>
	<br/>
	<?php 
	foreach ($all as $j){
	...
	<table class="tableizer-table2">
	 ...
	 <td width="50%">&nbsp;</td><td width="10%" align="left">Apply to</td><td width="2%" align="left">:</td><td width="13%" style="border-bottom: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;">Settlement</td></tr>
	</table>
	<br/>
