...
$this->fpdf->Cell(28.5,0.8,$tower,0,0,'C');
$this->fpdf->Ln();
$this->fpdf->Cell(28.5,0.4,$alamat,0,0,'C');
$this->fpdf->Ln();
...
$this->fpdf->Cell(3.2 , 0.5, 'Departemen' , 1, 'LR', 'C');
$this->fpdf->Cell(9.5 , 0.5, 'Keterangan' , 1, 'LR', 'C');
...
$this->fpdf->Cell(3.2 , 0.5, $b->nama_dept , 1, 'LR', 'C');
$this->fpdf->Cell(9.5 , 0.5, $b->keterangan , 1, 'LR', 'L');
