...
$this->fpdf->SetFont('Times','B',12);
$this->fpdf->Cell(4 , 0.5, 'Kode CashFlow' , 0, 'LR', 'L');
$this->fpdf->Cell(9 , 0.5, 'Nama CashFlow' , 0, 'LR', 'C');
$this->fpdf->Cell(3 , 0.5, 'Kode Alternative' , 0, 'LR', 'L');
$this->fpdf->Cell(3 , 0.5, 'Type' , 0, 'LR', 'C');
...
$this->fpdf->Cell(4 , 0.5, $p->kode_cflow , 0, 'LR', 'L');
				if($p->level == 1){
					$a = $p->nama_cflow;
				}elseif($p->level == 2){
					$a = ' '.$p->nama_cflow;
...
$this->fpdf->Cell(3 , 0.5, $p->type , 0, 'LR', 'C');
}
