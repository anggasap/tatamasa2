...
<html lang="en">
  ...
  <body>
	...
	<tr class="tableizer-firstrow"><th colspan="14">REIMBURSMENT PAYMENT</th></tr>
	</table>
	<?php 
	//print_r($reimpay);
	...
	<table class="tableizer-table2">
	 ...
	 <tr><td>&nbsp;</td><td width="20%">Requesting Department</td><td width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->nama_dept; ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Name</td>
	 <td colspan="2" width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 ...
	 <td colspan="2" rowspan="3" width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 ...
	 <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td>Date</td><td width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 ...
	 <tr><td>&nbsp;</td><td width="15%">Name</td><td width="25%" align="center" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 ...
	 echo $g;
	 }else{ echo '';} ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan="2" width="20%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;" align="center">Shahla Rahardjo</td><td width="20%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;" align="center">Laila Adikreshna</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td rowspan="3">Signature</td>
	 <td width="25%" rowspan="3" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 ...
	 <img id="img" height="50%" src="<?php echo base_url('metronic/img/paid.png'); ?>">
	 <?php }else{ echo '';} ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan="2" rowspan="3" width="20%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td rowspan="3" width="20%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td>&nbsp;</td></tr>
	...
	<table class="tableizer-table2">
	 <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="2">Ammount</td><td width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php echo number_format($a->jml_uang,2,'.',','); ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>Pay To PC Holder</td><td width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php echo $a->pay; ?></td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td colspan="2">Due Date</td><td width="25%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php echo tgl_indo($a->tgl_jt); ?></td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
	 ...
	 <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td colspan="12" style="border-bottom: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
	</table>
	<br/>
	<table class="tableizer-table2">
	 ...
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_fpe == '1'){echo 'V';}else{echo '';} ?></td><td width="25%" colspan="7">Faktur Penjualan (Invoice) Asli</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_po == '1'){echo 'V';}else{echo '';} ?></td><td width="20%" colspan="7">Purchase Order (PO)</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_bast == '1'){echo 'V';}else{echo '';} ?></td><td colspan="7"> Berita Acara Serah Terima (BAST)</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_kuitansi == '1'){echo 'V';}else{echo '';} ?></td><td width="25%" colspan="7">Kwitansi (Receipt) Asli</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_suratjalan == '1'){echo 'V';}else{echo '';} ?></td><td width="20%" colspan="7">Surat Jalan (Delivery Order)</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_pc == '1'){echo 'V';}else{echo '';} ?></td><td colspan="7"> Petty Cash/Advance Requisition</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_fpa == '1'){echo 'V';}else{echo '';} ?></td><td width="25%" colspan="7">Faktur Pajak Asli</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_lappenerimaanbrg == '1'){echo 'V';}else{echo '';} ?></td><td width="20%" colspan="7">Laporan Penerimaan Barang / Pelaksanaan Jasa</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->dok_lpkk == '1'){echo 'V';}else{echo '';} ?></td><td colspan="6"> Laporan Penggunaan Kas Kecil</td></tr>
	 <tr><td colspan="24">&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td  width="20%" colspan="9">Catatan Penggunaan Anggaran (CPA)</td><td>&nbsp;</td><td colspan="5">&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">&nbsp;</td><td colspan="5">Lain - lain</td><td>&nbsp;</td></tr>
	 <tr><td>&nbsp;</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->inout_budget == '0'){ echo 'V';}else{ echo '';}?></td><td colspan="4">Within Budget</td><td>&nbsp;</td><td width="2%" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;"><?php if($a->inout_budget == '1'){ echo 'V';}else{ echo '';}?></td><td colspan="3">Out of Budget</td><td colspan="9">&nbsp;</td></tr>
	 ...
	 <tr><td>&nbsp;</td><td colspan="5">&nbsp;</td><td>Name</td><td colspan="4" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif; width: 20%">
	 <?php if($a->app_hd_status != '0'){
	 $query = $this->db->query("select nama_kyw as nama from master_karyawan where id_kyw =".$a->app_hd_id."");
	 if($query->num_rows()== '1'){
	 $g = $query->row()->nama;
	 ...
	 <td colspan="4" rowspan="3" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 <?php if($a->app_hd_status != 0){?>
	 ...
	 <td colspan="4" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
	 <?php if($a->app_hd_status != '0'){ echo tgl_indo($a->app_hd_tgl);}else{ echo '';} ?></td><td colspan="4">&nbsp;</td>
	 <td>Date</td><td colspan="5" style="border: 1px solid #000; font-family: Arial, Helvetica, sans-serif;">
