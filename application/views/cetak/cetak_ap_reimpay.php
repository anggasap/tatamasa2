...
<html lang="en">
  ...
  <body style="width:100%;">
	...
	<table class="tableizer-table3">
	 ...
	 <tr><td width="3%">&nbsp;</td><td width="15%" align="left">No. Request</td><td width="3%">:</td><td width="25%" style="border-bottom: 1px solid #CCC; font-family: Arial, Helvetica, sans-serif;"><?php echo $j->id_reimpay; ?></td>
