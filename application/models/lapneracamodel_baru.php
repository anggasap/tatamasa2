...
class Lapneracamodel_baru extends CI_Model {
	...
	function get_data_neraca_hanya_header($tgl_trans,$user_id){
		$sql = "SELECT wt.*,wt2.kode_perk as kp,wt2.saldo_akhir as sa from web_temp_perkiraan wt
				left join web_temp_perkiraan2 wt2 on wt.kode_perk = wt2.kode_perk
				where wt.user_id = '".$user_id."' and wt.tanggal <= '".$tgl_trans."' and wt.type = 'G' 
		AND (left(wt.kode_perk,1)='1' OR left(wt.kode_perk,1)='2' OR left(wt.kode_perk,1)='3') order by wt.kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function get_data_neraca_bukan_nol($tgl_trans,$user_id){
		$sql = "SELECT wt.*,wt2.kode_perk as kp,wt2.saldo_akhir as sa from web_temp_perkiraan wt
				left join web_temp_perkiraan2 wt2 on wt.kode_perk = wt2.kode_perk
				where wt.user_id = '".$user_id."' and wt.tanggal <= '".$tgl_trans."' and wt.saldo_akhir != 0 
		AND (left(wt.kode_perk,1)='1' OR left(wt.kode_perk,1)='2' OR left(wt.kode_perk,1)='3') order by wt.kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function get_data_neraca_bukan_nol_hanya_header($tgl_trans,$user_id){
		$sql = "SELECT wt.*,wt2.kode_perk as kp,wt2.saldo_akhir as sa from web_temp_perkiraan wt
				left join web_temp_perkiraan2 wt2 on wt.kode_perk = wt2.kode_perk
				where wt.user_id = '".$user_id."' and wt.tanggal <= '".$tgl_trans."' and wt.type = 'G' and wt.saldo_akhir != 0
		AND (left(wt.kode_perk,1)='1' OR left(wt.kode_perk,1)='2' OR left(wt.kode_perk,1)='3') order by wt.kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();
	}
	...
	function get_labarugi_berjalan2(){
		$sql = "SELECT ((select sum(saldo_akhir) as total_pendapatan from web_temp_perkiraan2 where kode_perk = 4) - 
				(select sum(saldo_akhir) as total_biaya from web_temp_perkiraan2 where kode_perk =5)) as lbrg_berjalan";
		$query = $this->db->query($sql)->row()->lbrg_berjalan;
		return $query;
	}
	...
	function insert_temp_aktiva2($tgl_trans,$user_id){
		...
		$sql .= "LEFT(web_temp_perkiraan2.kode_perk,1)=1 order by kode_perk asc";
		$query = $this->db->query($sql);					   
	}
	...
	function get_data_pasiva2(){
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE (left(kode_perk,1)='2' OR left(kode_perk,1)='3') order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();	
	}
	//end dengan 0;
	...
	function insert_temp_aktiva_hanya_header($tgl_trans,$user_id){
		...
		$sql .= "SELECT '".$user_id."' as user_id,'".$tgl_trans."' as tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir,'','','','','0','','0' ";
		$sql .= "FROM web_temp_perkiraan2 WHERE "; 			
		$sql .= "LEFT(web_temp_perkiraan2.kode_perk,1)=1 and type='G' order by kode_perk asc";
		$query = $this->db->query($sql);					   
	}
	...
	function get_data_pasiva_hanya_header(){
		...
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE (left(kode_perk,1)='2' OR left(kode_perk,1)='3') and type='G' order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();	
	}
	...
	function insert_temp_aktiva_tanpa_02($tgl_trans,$user_id){
		...
		$sql .= "SELECT '".$user_id."' as user_id,'".$tgl_trans."' as tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir,'','','','','0','','0' ";
		$sql .= "FROM web_temp_perkiraan2 WHERE "; 			
		$sql .= "LEFT(web_temp_perkiraan2.kode_perk,1)=1 and saldo_akhir != 0 order by kode_perk asc";
		$query = $this->db->query($sql);					   
	}
	...
	function get_data_aktiva_tanpa_0(){
		...
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE 			
		LEFT(web_temp_perkiraan2.kode_perk,1)=1 and saldo_akhir != 0 order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();		
	}
	...
	function get_data_pasiva_tanpa_0(){
		...
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE (left(kode_perk,1)='2' OR left(kode_perk,1)='3') and saldo_akhir != 0 order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();	
	}
	//end tanpa 0
	...
	function insert_temp_aktiva_tanpa_0_hanya_header2($tgl_trans,$user_id){
		...
		$sql .= "SELECT '".$user_id."' as user_id,'".$tgl_trans."' as tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir,'','','','','0','','0' ";
		$sql .= "FROM web_temp_perkiraan2 WHERE "; 			
		$sql .= "LEFT(web_temp_perkiraan2.kode_perk,1)=1 and saldo_akhir != 0 and type='G' order by kode_perk asc";
		$query = $this->db->query($sql);					   
	}
	...
	function get_data_aktiva_tanpa_0_hanya_header2(){
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE 			
		LEFT(web_temp_perkiraan2.kode_perk,1)=1 and saldo_akhir != 0 and type='G' order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();		
	}
	...
	function get_data_pasiva_tanpa_0_hanya_header2(){
		$sql = "SELECT user_id,tanggal,kode_perk,kode_alt,nama_perk,type,level,kode_induk,saldo_akhir
		FROM web_temp_perkiraan2 WHERE (left(kode_perk,1)='2' OR left(kode_perk,1)='3') and saldo_akhir != 0 and type='G' order by kode_perk asc";
		$query = $this->db->query($sql);
		return $query->result();	
	}
